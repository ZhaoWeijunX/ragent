...
} from "@/pages/admin/settings/ModelCandidateProbeTable";
import {
  mergeProbeResults,
  probeAllModels,
  probeModel,
  ...
  return (
    <div className="settings-card">
      <div className="settings-card-title">
        ...
        {probe ? (
          <span className={cn("inline-flex", !group.defaultModel && "ml-auto")}>
            <ModelGroupProbeButton
              probing={probe.probing}
              disabled={(group.candidates ?? []).length === 0}
              onClick={probe.onProbeGroup}
            />
          </span>
        ) : null}
      </div>
      {probe ? (
        <ModelCandidateProbeTable
          ...
          probingKeys={probe.probingKeys}
          onProbeOne={probe.onProbeOne}
        />
      ) : (
        <Table>
          <TableHeader>
      ...
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle">
            application.yaml 运行时生效配置的只读视图，修改后需重启服务；支持主动探测模型连通性
          </p>
          {lastProbedAt ? (
        ...
        <div className="settings-card">
          ...
          <div className="mt-5">
            ...
            <ModelCandidateProbeTable
              ...
              defaultModel={ai.chat.defaultModel}
              extraColumns={[
                {
                  header: "深度思考",
                  ...
                  render: (item) =>
                    item.supportsThinking ? (
                      <StateTag on tone="violet" onText="支持" />
                    ) : (
        ...
        <div className="space-y-4">
          <ModelCandidatesCard
            ...
            probe={{
              ...
              onProbeGroup: () => handleProbeCapability("embedding"),
              onProbeOne: handleProbeOne
            }}
          />
          <ModelCandidatesCard
            ...
            probe={{
              ...
              onProbeGroup: () => handleProbeCapability("rerank"),
              onProbeOne: handleProbeOne
            }}
          />
          {vlm ? (
