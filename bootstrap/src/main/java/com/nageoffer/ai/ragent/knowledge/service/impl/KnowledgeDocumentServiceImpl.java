...
public class KnowledgeDocumentServiceImpl implements KnowledgeDocumentService {
    ...
    public FeishuWikiPageImportResult importFeishuWikiPage(String kbId, String wikiUrl, String feishuNodeToken,
        ...
        if (existing != null) {
            ...
            existing.setMimeType(stored.getMimeType());
            ...
            existing.setIngestionSpec(modeConfig.ingestionSpec());
            ...
            return new FeishuWikiPageImportResult(toVO(existing), true);
        }
        ...
        KnowledgeDocumentDO documentDO = KnowledgeDocumentDO.builder()
                ...
                .build();
        documentMapper.insert(documentDO);
        return new FeishuWikiPageImportResult(toVO(documentDO), false);
    }
