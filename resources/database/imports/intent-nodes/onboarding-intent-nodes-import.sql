...
--
-- 适用文档目录：resources/knowledge-samples/knowledge/group/onboarding/（7 篇多格式文档）
-- 设计说明：resources/knowledge-samples/knowledge/group/onboarding/intent-tree-design.md
--
-- 文档清单：
--   新员工入职指南.md            (Markdown)
--   入职第一天待办.txt             (Tika)
...
--   __COLLECTION_ONBOARDING__  -> 该知识库对应的 collection_name
--
...
-- ========== DOMAIN ==========
(
    2059300000000000001, '__KB_ID_ONBOARDING__', 'onboarding', '新员工入职与培训', 0, NULL,
...
-- ========== CATEGORY: 入职流程 ==========
(
    2059300000000000002, '__KB_ID_ONBOARDING__', 'onb-process', '入职流程', 1, 'onboarding',
    '入职前准备、入职当天全流程、首周安排、Buddy 制度与试用期目标；讨论入职指南而非首日 checklist 勾选',
    '[]', NULL, NULL, NULL, 0, NULL, NULL, NULL,
    10, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059300000000000003, '__KB_ID_ONBOARDING__', 'onb-process-guide', '入职指南', 2, 'onb-process',
    ...
    '__COLLECTION_ONBOARDING__', 8, NULL, 0, NULL, NULL, NULL,
    11, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059300000000000004, '__KB_ID_ONBOARDING__', 'onb-process-firstday', '首日待办', 2, 'onb-process',
    ...
    '__COLLECTION_ONBOARDING__', 6, NULL, 0, NULL, NULL, NULL,
    12, 1, 'admin', 'admin', NOW(), NOW(), 0
),

-- ========== CATEGORY: 制度与手册 ==========
(
    2059300000000000005, '__KB_ID_ONBOARDING__', 'onb-handbook', '制度与手册', 1, 'onboarding',
    '员工手册制度条款与典型岗位职责说明书；讨论年假考勤离职或 JD 任职资格',
    '[]', NULL, NULL, NULL, 0, NULL, NULL, NULL,
    20, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059300000000000006, '__KB_ID_ONBOARDING__', 'onb-handbook-employee', '员工手册', 2, 'onb-handbook',
...
(
    2059300000000000007, '__KB_ID_ONBOARDING__', 'onb-handbook-jd', '岗位职责', 2, 'onb-handbook',
...
-- ========== CATEGORY: 培训体系 ==========
(
    2059300000000000008, '__KB_ID_ONBOARDING__', 'onb-training', '培训体系', 1, 'onboarding',
    '入职必修与通用/专业/管理类培训课程表、报名与开课时间',
    '[]', NULL, NULL, NULL, 0, NULL, NULL, NULL,
    30, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059300000000000009, '__KB_ID_ONBOARDING__', 'onb-training-courses', '培训课程', 2, 'onb-training',
...
-- ========== CATEGORY: 办公与环境 ==========
(
    2059300000000000010, '__KB_ID_ONBOARDING__', 'onb-facility', '办公与环境', 1, 'onboarding',
    '办公楼层工位、门禁权限、停车场与集团组织架构',
    '[]', NULL, NULL, NULL, 0, NULL, NULL, NULL,
    40, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059300000000000011, '__KB_ID_ONBOARDING__', 'onb-facility-location', '办公地点与门禁', 2, 'onb-facility',
...
(
    2059300000000000012, '__KB_ID_ONBOARDING__', 'onb-facility-orgchart', '组织架构', 2, 'onb-facility',
