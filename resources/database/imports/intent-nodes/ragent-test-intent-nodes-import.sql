...
--   RAG 评测（11）| Ollama与vLLM扫盲（3）| 技术文档（2）
...
--   __COLLECTION_RAGENT_TEST__  -> 该知识库对应的 collection_name
--
...
--     'tech-docs', 'tech-docs-threadpool', 'tech-docs-patterns'
-- );
...
-- ========== DOMAIN ==========
(
    2059100000000000001, '__KB_ID_RAGENT_TEST__', 'ragent-docs', 'Ragent 技术专栏', 0, NULL,
...
-- ========== CATEGORY: AI知识库建设 ==========
(
    2059100000000000002, '__KB_ID_RAGENT_TEST__', 'kb-build', 'AI知识库建设', 1, 'ragent-docs',
    '知识库系统的宏观架构、文档上传、分块入库、文档管理与 URL 定时同步',
    '[]', NULL, NULL, NULL, 0, NULL, NULL, NULL,
    10, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059100000000000003, '__KB_ID_RAGENT_TEST__', 'kb-build-arch', '知识库宏观设计', 2, 'kb-build',
    '知识库三层架构、核心概念（知识库/文档/分块）、数据库表设计、异步处理流程、多知识库隔离',
    '["Ragent 知识库系统整体架构是怎样的？","知识库、文档、分块三者是什么关系？","文档从上传到入库的完整流程是什么？","企业级知识库系统分哪几层？"]',
    '__COLLECTION_RAGENT_TEST__', 6, NULL, 0, NULL, NULL, NULL,
    11, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059100000000000004, '__KB_ID_RAGENT_TEST__', 'kb-build-upload-size', '文件上传与内存优化', 2, 'kb-build',
    ...
    '__COLLECTION_RAGENT_TEST__', 8, NULL, 0, NULL, NULL, NULL,
    12, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059100000000000005, '__KB_ID_RAGENT_TEST__', 'kb-build-upload-ratelimit', '上传分布式限流', 2, 'kb-build',
...
(
    2059100000000000006, '__KB_ID_RAGENT_TEST__', 'kb-build-upload-api', '文档上传接口', 2, 'kb-build',
...
(
    2059100000000000007, '__KB_ID_RAGENT_TEST__', 'kb-build-chunk', '分块处理与管理', 2, 'kb-build',
...
(
    2059100000000000008, '__KB_ID_RAGENT_TEST__', 'kb-build-doc-api', '文档管理接口', 2, 'kb-build',
...
(
    2059100000000000009, '__KB_ID_RAGENT_TEST__', 'kb-build-sync', 'URL定时同步', 2, 'kb-build',
...
-- ========== CATEGORY: 大模型调度引擎实战 ==========
(
    2059100000000000010, '__KB_ID_RAGENT_TEST__', 'infra-ai', '大模型调度引擎实战', 1, 'ragent-docs',
    'Ragent 的 infra-ai 模块：多供应商 Chat/Embedding/Rerank 统一调用、模型路由、熔断与流式执行',
    '[]', NULL, NULL, NULL, 0, NULL, NULL, NULL,
    20, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059100000000000011, '__KB_ID_RAGENT_TEST__', 'infra-ai-arch', 'AI基础设施层宏观设计', 2, 'infra-ai',
...
(
    2059100000000000012, '__KB_ID_RAGENT_TEST__', 'infra-ai-route-circuit', '多模型路由与熔断', 2, 'infra-ai',
...
(
    2059100000000000013, '__KB_ID_RAGENT_TEST__', 'infra-ai-chat-stream', 'Chat调用与流式路由', 2, 'infra-ai',
...
(
    2059100000000000014, '__KB_ID_RAGENT_TEST__', 'infra-ai-embedding', 'Embedding向量化客户端', 2, 'infra-ai',
...
(
    2059100000000000015, '__KB_ID_RAGENT_TEST__', 'infra-ai-rerank', 'Rerank重排序', 2, 'infra-ai',
...
-- ========== CATEGORY: AI知识问答 ==========
(
    2059100000000000027, '__KB_ID_RAGENT_TEST__', 'rag-qa', 'AI知识问答', 1, 'ragent-docs',
    'StreamChatPipeline 八阶段问答全链路：记忆、改写、意图、检索、MCP、Prompt、流式、排队限流',
    '[]', NULL, NULL, NULL, 0, NULL, NULL, NULL,
    45, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059100000000000028, '__KB_ID_RAGENT_TEST__', 'rag-qa-pipeline', '问答全链路全景', 2, 'rag-qa',
...
(
    2059100000000000029, '__KB_ID_RAGENT_TEST__', 'rag-qa-memory', '会话记忆与摘要', 2, 'rag-qa',
...
(
    2059100000000000030, '__KB_ID_RAGENT_TEST__', 'rag-qa-rewrite', '查询改写与拆分', 2, 'rag-qa',
...
(
    2059100000000000031, '__KB_ID_RAGENT_TEST__', 'rag-qa-intent', '意图识别与引导', 2, 'rag-qa',
...
(
    2059100000000000032, '__KB_ID_RAGENT_TEST__', 'rag-qa-retrieval', '多通道检索与后处理', 2, 'rag-qa',
...
(
    2059100000000000033, '__KB_ID_RAGENT_TEST__', 'rag-qa-mcp', 'MCP工具调用', 2, 'rag-qa',
...
(
    2059100000000000034, '__KB_ID_RAGENT_TEST__', 'rag-qa-prompt', 'Prompt组装', 2, 'rag-qa',
...
(
    2059100000000000035, '__KB_ID_RAGENT_TEST__', 'rag-qa-stream', '流式生成链路', 2, 'rag-qa',
...
(
    2059100000000000036, '__KB_ID_RAGENT_TEST__', 'rag-qa-ratelimit', '排队限流', 2, 'rag-qa',
...
-- ========== CATEGORY: RAG 评测 ==========
(
    2059100000000000016, '__KB_ID_RAGENT_TEST__', 'rag-eval', 'RAG 评测', 1, 'ragent-docs',
    'Ragent 评测体系：评估集设计、runner 双接口录制、自建指标、RAGAS 实践与测评报告（ragenteval 项目）',
    '[]', NULL, NULL, NULL, 0, NULL, NULL, NULL,
    30, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059100000000000017, '__KB_ID_RAGENT_TEST__', 'rag-eval-setup', '评测基建与数据初始化', 2, 'rag-eval',
...
(
    2059100000000000018, '__KB_ID_RAGENT_TEST__', 'rag-eval-runner', '评测录制与全链路', 2, 'rag-eval',
...
(
    2059100000000000019, '__KB_ID_RAGENT_TEST__', 'rag-eval-metrics-intent-retrieval', '意图与检索指标', 2, 'rag-eval',
...
(
    2059100000000000020, '__KB_ID_RAGENT_TEST__', 'rag-eval-metrics-performance', '性能指标', 2, 'rag-eval',
...
(
    2059100000000000021, '__KB_ID_RAGENT_TEST__', 'rag-eval-ragas', 'RAGAS评测实践', 2, 'rag-eval',
...
(
    2059100000000000022, '__KB_ID_RAGENT_TEST__', 'local-llm', 'Ollama与本地部署', 1, 'ragent-docs',
    '本地大模型部署动机、合规与成本选型、Ollama 架构与安装调用实战',
    '[]', NULL, NULL, NULL, 0, NULL, NULL, NULL,
    40, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059100000000000023, '__KB_ID_RAGENT_TEST__', 'local-llm-why', '为什么本地部署', 2, 'local-llm',
...
(
    2059100000000000024, '__KB_ID_RAGENT_TEST__', 'local-llm-ollama', 'Ollama概念与实战', 2, 'local-llm',
...
-- ========== CATEGORY: 技术文档 ==========
(
    2059100000000000025, '__KB_ID_RAGENT_TEST__', 'tech-docs', '技术文档', 1, 'ragent-docs',
    '横切技术专题：并发与线程池、设计模式全景等不隶属于单一业务系列的深度实现文档',
    '[]', NULL, NULL, NULL, 0, NULL, NULL, NULL,
    50, 1, 'admin', 'admin', NOW(), NOW(), 0
),
(
    2059100000000000026, '__KB_ID_RAGENT_TEST__', 'tech-docs-threadpool', '线程池设计与实现', 2, 'tech-docs',
...
(
    2059100000000000027, '__KB_ID_RAGENT_TEST__', 'tech-docs-patterns', '设计模式全景', 2, 'tech-docs',
    'Ragent 后端真实落地的设计模式：模板方法、策略、工厂/注册表、责任链/流水线、观察者、熔断、组合、访问者、适配器、装饰器、外观等；对应 ChatClient、SearchChannel、IngestionEngine、StreamChatPipeline 等扩展点',
    '["Ragent 里用了哪些设计模式？","策略模式在检索通道和文档解析里怎么落地？","IngestionEngine 和 StreamChatPipeline 分别对应什么模式？","模板方法在 AbstractOpenAIStyleChatClient 里解决什么问题？","工厂和注册表在分块策略、解析器选择里怎么用？"]',
    '__COLLECTION_RAGENT_TEST__', 8, NULL, 0, NULL, NULL, NULL,
    52, 1, 'admin', 'admin', NOW(), NOW(), 0
);
