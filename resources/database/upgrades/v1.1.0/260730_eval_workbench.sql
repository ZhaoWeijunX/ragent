-- v1.1.0 260730 RAG evaluation workbench tables
-- Canonical: resources/database/evaluation/schema_eval_workbench.sql
-- Keep in sync with the canonical script for existing DB upgrades.
