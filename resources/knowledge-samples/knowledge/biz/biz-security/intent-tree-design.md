...
本文档描述 `resources/knowledge-samples/knowledge/biz/biz-security/` 目录下 **7 篇多格式文档** 的意图树划分方案，用于 Ragent 意图分类与定向检索。
...
2. 上传 `resources/knowledge-samples/knowledge/biz/biz-security/` 目录下全部 7 个文件，完成分块入库。
