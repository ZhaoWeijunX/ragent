...
```bash
# 1. 只预览，不改数据
python scripts/migration/migrate_storage_s3_urls.py

# 2. 试跑一条
python scripts/migration/migrate_storage_s3_urls.py --limit 1 --doc-id 2074327680513388544

# 3. 确认后执行
python scripts/migration/migrate_storage_s3_urls.py --apply
```
