...
用法示例:
  # 预览
  python scripts/maintenance/cleanup_orphan_knowledge.py

  # 只看某个 doc
  python scripts/maintenance/cleanup_orphan_knowledge.py --doc-id 2073960493273477120

  # 确认后执行
  python scripts/maintenance/cleanup_orphan_knowledge.py --apply
