...
用法:
  ...
  # 执行（建议先 dry-run）
  python scripts/purge_soft_deleted.py --apply

  # 更保守：只清 24h 前的软删，批次更小
  python scripts/purge_soft_deleted.py --apply --min-age-hours 24 --batch-size 1000

  # 自定义连接
  python scripts/purge_soft_deleted.py --pg-dsn "postgresql://postgres:postgres@localhost:5432/ragent"
"""
