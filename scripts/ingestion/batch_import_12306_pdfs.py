...
# -*- coding: utf-8 -*-
"""
将 resources/knowledge-samples/12306-pdf-doc/ 下的 PDF 批量导入知识库，
...
用法示例:
  ...
  python scripts/ingestion/batch_import_12306_pdfs.py

  # 指定已有知识库，跳过同名已存在文档
  python scripts/ingestion/batch_import_12306_pdfs.py --kb-id <KB_ID> --skip-existing

  # 仅上传不触发分块
  python scripts/ingestion/batch_import_12306_pdfs.py --upload-only

  # 对已存在但失败的文档重新触发分块
  python scripts/ingestion/batch_import_12306_pdfs.py --kb-id <KB_ID> --retry-failed
...
DEFAULT_DOCS_DIR = REPO_ROOT / "resources" / "knowledge-samples" / "12306-pdf-doc"
