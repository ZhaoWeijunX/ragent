...
```bash
# 1. 导入意图节点
psql -f resources/database/imports/mcp-weather/intent-nodes.sql
...
- [`mcp-weather/intent-nodes.sql`](../../../resources/database/imports/mcp-weather/intent-nodes.sql)
...
- **天气专属**：[`mcp-weather/intent-nodes.sql`](../../../resources/database/imports/mcp-weather/intent-nodes.sql) 中的 `param_prompt_template`
...
└── ../mcp-weather/intent-nodes.sql                  # 节点与天气专属 param_prompt（一次导入）
