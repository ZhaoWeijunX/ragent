...
```bash
psql -h localhost -U postgres -d ragent -f resources/database/imports/mcp-business/schema.sql
psql -h localhost -U postgres -d ragent -f resources/database/imports/mcp-business/seed.sql
psql -h localhost -U postgres -d ragent -f resources/database/imports/mcp-business/intent-nodes.sql
```

意图节点与专属提示词由 `mcp-business/intent-nodes.sql` 一次写入数据库；完整导入说明见 [`resources/database/imports/README.md`](../../../resources/database/imports/README.md)。
...
- `resources/database/imports/mcp-business/schema.sql`
- `resources/database/imports/mcp-business/seed.sql`
