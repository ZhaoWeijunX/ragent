...
| ADR 冻结状态机 / Thinking / 业务码 / 恢复等 | 通过 | `docs/evaluation/phase-0-adr.md` |
| RAGAS HTTP 服务契约设计完成 | 通过 | `docs/evaluation/ragas-scoring-service-contract.md` |
...
| 开发方案勾选 | `docs/rag-evaluation-workbench-development-plan.md` |
